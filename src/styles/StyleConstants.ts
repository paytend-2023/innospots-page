...
export const SPACE_LXG = SPACE_TIMES(6); // 24
...
// base color
export const BLUE = '#1245FA';
export const GREEN = '#31CB8A';
export const ORANGE = '#F57A60';
export const YELLOW = '#FCC465';
export const RED = '#FF4445';

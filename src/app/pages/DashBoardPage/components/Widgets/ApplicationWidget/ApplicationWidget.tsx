...
import { ApplicationWidgetCore } from './ApplicationWidgetCore';
import { ApplicationWidgetContent } from '../../../pages/Board/slice/types';

export const ApplicationWidget: React.FC<{ hideTitle: boolean }> = memo(
  ({ hideTitle }) => {
    ...
    return (
      <WidgetWrapper background={background} border={border} padding={padding}>
        <div style={ZIndexStyle}>
          ...
          <div style={FlexStyle}>
            <ApplicationWidgetCore applicationWidgetContent={content}/>
          </div>
        </div>
        {editing && <EditMask />}
        <StyledWidgetToolBar>

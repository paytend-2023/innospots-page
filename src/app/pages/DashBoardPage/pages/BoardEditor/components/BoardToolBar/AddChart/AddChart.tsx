...
export const AddChart = () => {
  ...
  return (
    <>
      <ChartWidgetDropdown onCreate={onCreateCharts} />
      {widgetChartVisible && (
        <ChartEditor
          dataChartId={`${BOARD_SELF_CHART_PREFIX}_${uuidv4()}`} // TODO(Stephen): widget id issue: generate uuid from frontend for own/link chart
          orgId={orgId}

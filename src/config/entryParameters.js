export const entryParameters = {
  page: {
    ...
    urls:{
      viewsUrl: `/apps/schema/data-set/list`,
      viewDetailUrl: `/apps/schema/data-set/:id`,
      dataUrl: `/apps/schema/data`,
      applicationsUrl: `/application/list`,
      detailUrl: `/page/:id`,
      saveBoardUrl: `/page`,
      publicBoardUrl: `/page/publish`,
      fileUploadUrl: `/page/files/image`,
      functionSupportUrl: `/apps/schema/data/function/support/:viewId`,
      functionValidateUrl: `/apps/schema/data/function/validate`,
